...
export type InvoiceDataType = {
  ...
  "Invoice Extended Cost": string
  "Project Code": string
  "Project Name": string
  "Sub Project Code": string
  "Sub Project Name": string
  "State Province ACC AMT": string
  "County ACC AMT": string
  "City ACC AMT": string
  "FRT State Province ACC AMT": string
  "FRT County ACC AMT": string
  "FRT City ACC AMT": string
}
